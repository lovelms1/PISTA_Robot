...
class TurtleBotAPI:
    ...
    def move(self, linear_speed=0.0, angular_speed=0.0, duration=2):
        """Publish both linear and angular velocities for a given duration."""
        twist = Twist()
    ...
    def get_lidar(self):
        """Alias for get_lidar_scan(): returns latest LiDAR ranges."""
